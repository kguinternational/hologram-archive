...
make atlas-lib          # Static library
make atlas-shared       # Shared library
make atlas-tools        # Command-line tools
make atlas-tests        # Test suite
...
make SIMD=avx512         # one of: sse2, avx2, avx512, neon, wasm

# Build with JIT support (if tools/atlas-jit is present)
make JIT=1
...
> **Tip:** CMake presets are provided for IDE workflows; see `llvm/CMakeLists.txt` if present.
