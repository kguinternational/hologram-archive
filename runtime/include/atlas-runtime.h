/* atlas-runtime.h - Atlas-12288 Layer 2 Host Runtime C API
 * (c) 2024-2025 UOR Foundation - MIT License
 * 
 * Public C ABI for Atlas-12288 Layer 2 host runtime providing:
 * - Domain lifecycle management with thread-safe state transitions
 ...
 * 
 * @return Last error code, or ATLAS_SUCCESS if no error occurred
 */
